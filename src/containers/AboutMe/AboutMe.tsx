      ...
      <section className={styles.wrapper}>
        ...
        <article>
          <p>
            ...
            the while, I always had a thought in the back of my mind that wanted
            to work with technology. Eventually I decided to get back to coding
            on my own, but I wasn't getting as much from that as I hoped, so I
